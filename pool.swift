public class pool{
    ...
    init(){
        ...
        let q5=question(quesText:"The highest average salinity amongst the following seas is reported from",options:["Dead Sea","Red Sea","Black Sea","Migration Sea"],labeloptions:["a","b","c","d"],difficultyRating:"easy",correctOption:"e")
        ...
        let q9=question(quesText:"Ema is an example of ",options:["Active volcano","Dormant Volcano"," Extinct volcano","Plateau in a volcano region"],labeloptions:["a","b","c","d"],difficultyRating:"medium",correctOption:"e")
        ...
        let q13=question(quesText:"what does the term 'Lithosphere' refer to",options:["Interior of the earth","Crust of the earth","Plants and animals","None of the above"],labeloptions:["a","b","c","d"],difficultyRating:"hard",correctOption:"e")
